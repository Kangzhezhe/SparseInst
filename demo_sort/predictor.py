...
class VisualizationDemo(object):
    ...
    def run_on_image(self, image, confidence_threshold):
        ...
        # ins = Instances(image.shape[0:2])
        # if len(instances.scores) > 0:
        #     ins.scores = instances.scores
        #     ins.pred_classes = instances.pred_classes
        #     ins.pred_masks =  instances.pred_masks
    ...
    def visualize(self, image, predictions,ids=None):
        ...
        vis_output = visualizer.draw_instance_predictions(predictions=ins,ids=ids)
        return vis_output
